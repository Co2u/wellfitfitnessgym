...
const AddItem = () => {
    ...
    const [inventoryPrice, setInventoryPrice] = useState(""); // Add price state
    ...
    const handleAddPlan = async (e) => { 
        ...
        if (
            ...
            !inventoryImage ||
            !inventoryPrice.trim() // Require price
        ) {
        ...
        formData.append("inventory_price", inventoryPrice); // Add price to form
        ...
        try {
          ...
          if (response.ok) {
            ...
            alert("Failed to add item."); // <-- Correct message
          }
        } catch (error) {
        ...
        <div className="card">
            <div className="card-body">
                ...
                <form onSubmit={handleAddPlan} encType="multipart/form-data">
                    ...
                    {/* Price */}
                    <div className="row mb-3">
                        <label htmlFor="inventory_price" className="col-sm-2 col-form-label">Price</label>
                        <div className="col-sm-10">
                            <input
                                type="number"
                                id="inventory_price"
