import{X as o,r as c,j as e}from"./app-CI1o2zDc.js";import{A as m,a as l,b as p,c as h}from"./Footer-Du3FwGAi.js";import{h as n}from"./moment-BLMuvzoS.js";import"./Helmet-BgtHYfTe.js";const x=()=>{const{get_membership_by_id:t}=o().props,r=c.useRef(null),a=()=>{const d=r.current.innerHTML,s=document.createElement("iframe");s.style.position="absolute",s.style.width="0",s.style.height="0",s.style.border="none",document.body.appendChild(s);const i=s.contentDocument||s.contentWindow.document;i.open(),i.write(`
      <html>
        <head>
